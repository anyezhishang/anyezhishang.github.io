    ...
    var o = e("HttpManagerJs"),
      ...
      r = (e("GameUiTools"), {
        ...
        getHttpGameId: function () {
          ...
          this.moreGameUrl = window.location.href
        },
              ...
              (this.pengzhuangCount += 1,
                0 == t.node.getComponent("fruitData").getNumber() && (a.default.score += this.fruitNumber + (extraScore ? extraScore : 1), // 改分数
                  ...
                  a.default.playerTouch = !1, cc.tween(t.node).to(.1, {
                    ...
                    var couponImgUrl = window.location.href + (window.location.href.split('#').length <= 1 ? '/assets/coupon.png' : '/ckpi/assets/coupon.png')

                    // 跳转到优惠券
                    $.ajax({
                      url: window.baseUrl + '/api-applet/wechat/getconfig',
                      type: 'GET',
                      data: {
                    ...
                    setTimeout(() => {
                      layer.open({
                        ...
                        moveType: 1 //拖拽模式，0或者1
                          ,
                        content: '<div id="layer-bg" class="layer-bg">' +
                          '<wx-open-launch-weapp id="launch-btn" username="gh_65561b67d894" path="/pages/voucherList/index.html">' +
                          '<template>' +
                          '<style>.btn {color: transparent;background-color: transparent;width: 100%;height: 200px;border: none;outline:none;}</style>' +
                          '<button id="coupon-btn" class="btn">打开小程序</button>' +
                          '</template>' +
